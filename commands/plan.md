---
name: plan
description: Create a structured implementation plan before making changes
---
...
6. **Testing**: How will we verify the change works? Existing tests? New tests? Manual checks?

7. **Order of operations**: In what order should the changes be made?
